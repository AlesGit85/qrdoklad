            ...
            <div class="col-lg-8 mx-auto">
                <div class="content-card bg-white p-4 p-md-5 rounded-3 shadow">
                        ...
                        <div class="col-md-4">
                            <div class="card border-primary text-center">
                                <div class="card-header bg-primary text-white">
                                    <h6 class="mb-0">Základní verze</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="text-primary">0 Kč</h4>
                                    <p class="card-text small">navždy zdarma</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-success text-center">
                                <div class="card-header bg-success text-white">
                                    <h6 class="mb-0">Rozšířené moduly</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="text-success">990 - 3990 Kč</h4>
                                    <p class="card-text small">jednorázově</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-warning text-center">
                                <div class="card-header bg-warning text-dark">
                                    <h6 class="mb-0">Vývoj na míru</h6>
                                </div>
                                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush mb-4">
                        <li class="list-group-item"><i class="bi bi-check-circle text-primary me-2"></i>Základní funkce jsou navždy zdarma</li>
                        <li class="list-group-item"><i class="bi bi-credit-card text-primary me-2"></i>Moduly se platí jednorázově při nákupu</li>
                        <li class="list-group-item"><i class="bi bi-infinity text-primary me-2"></i>Zakoupené moduly máte navždy bez dalších poplatků</li>
                        <li class="list-group-item"><i class="bi bi-shield-check text-success me-2"></i>Žádné skryté poplatky ani obnovování předplatného</li>
                    </ul>
                            ...
                            <div id="collapseProvider" class="accordion-collapse collapse" data-bs-parent="#rightsAccordion">
                                <div class="accordion-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>Technická podpora dle možností</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0">
                            ...
                            <li><strong>Data:</strong> Dostupná 30 dní po ukončení pro export</li>
                            <li><strong>Refundace:</strong> U jednorázových modulů se nevrací (máte je navždy)</li>
                        </ul>
                    </div>
                    ...
                    <p>
                        ...
                        100% dostupnost. Odpovědnost je omezena na výši zaplacených poplatků za rozšířené moduly.
                    </p>
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>• Technickou podporu dle možností</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>• Chybovost třetích stran (ARES, banky)</li>
                                        <li>• Náhradu škod z výpadků</li>
                    ...
                    <h2 class="text-primary mb-4 mt-5">8. Duševní vlastnictví</h2>
                    <div class="alert alert-info">
                        <h6 class="alert-heading"><i class="bi bi-copyright me-2"></i>Autorská práva</h6>
                        <p>Všechna práva k software QRdoklad zůstávají u provozovatele. Zakoupením modulů získáváte pouze právo k jejich používání, ne vlastnictví.</p>
                        <p class="mb-0"><strong>Vaše data:</strong> Všechna data, která vložíte do systému (faktury, klienti, atd.) zůstávají vaším vlastnictvím.</p>
                    </div>

                    <h2 class="text-primary mb-4 mt-5">9. Změny podmínek</h2>
                    <p>
                        Tyto obchodní podmínky můžeme změnit. O významných změnách vás budeme 
                        informovat e-mailem nejméně 30 dní předem.
                    </p>

                    <h2 class="text-primary mb-4 mt-5">10. Závěrečná ustanovení</h2>
                    <ul class="list-group list-group-flush mb-4">
